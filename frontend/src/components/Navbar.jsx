      ...
      >
        ...
        <div className="flex items-center justify-between">
          ...
          <div className="hidden lg:flex items-center space-x-1 pr-4 sm:pr-6 lg:pr-8">
            ...
            <button
              onClick={toggleTheme}
              className="ml-3 p-2.5 rounded-lg transition-all duration-200 bg-gradient-to-br from-primary-50 to-primary-100 dark:from-gray-700 dark:to-gray-800 border border-primary-200 dark:border-gray-600 text-primary-600 dark:text-primary-400 hover:from-primary-100 hover:to-primary-200 dark:hover:from-gray-600 dark:hover:to-gray-700 hover:border-primary-300 dark:hover:border-primary-500 flex items-center justify-center shadow-sm hover:shadow-md"
            ...
            >
              ...
              <div className="flex-1 overflow-y-auto overflow-x-hidden p-4 pb-6 min-h-0 relative z-10 bg-white" style={{ visibility: 'visible' }}>
                ...
                <div className="flex flex-col space-y-3">
                  ...
                  <button
                    onClick={toggleTheme}
                    className="flex items-center justify-center space-x-2 w-full px-4 py-3.5 rounded-lg font-medium transition-all bg-gradient-to-br from-primary-50 to-primary-100 dark:from-gray-700 dark:to-gray-800 border border-primary-200 dark:border-gray-600 text-primary-600 dark:text-primary-400 hover:from-primary-100 hover:to-primary-200 dark:hover:from-gray-600 dark:hover:to-gray-700 mt-2"
                  >
                    {theme === 'dark' ? (
                      <>
                        <FiSun className="text-amber-500" size={18} />
